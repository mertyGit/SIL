...
/*****************************************************************************
  load a PNG directly into a new layer

  In: Context of layer, filename , x and y position *of new layer* on display
  Out: pointer to layer (use sil_getErr()) to get errorcode when layer is NULL
